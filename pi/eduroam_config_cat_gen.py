...
# -*- coding: utf-8 -*-
"""
 * edited so that NM_AVAILABLE is false, originally from https://cat.eduroam.org/
...
Config.instname = "University of Iowa"
Config.profilename = "Everyone"
Config.url = "http://its.uiowa.edu/helpdesk"
Config.email = "its-helpdesk@uiowa.edu"
Config.title = "eduroam CAT"
Config.server_match = "net-auth-1.its.uiowa.edu"
...
Config.user_realm = "uiowa.edu"
Config.ssids = ['eduroam']
Config.del_ssids = ['UI-DeviceNet', 'UI-Guest', 'eduroam-test']
Config.servers = ['DNS:net-auth-1.its.uiowa.edu']
